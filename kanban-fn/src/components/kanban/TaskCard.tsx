...
export default function TaskCard({ task, onDelete }: Props) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 cursor-grab active:cursor-grabbing hover:shadow-md hover:border-purple-200 transition group"
    >
